...
The content is presented in a simple and easy-to-understand format, helping you learn important concepts, revise efficiently, and practice with previous-year questions.', 
    ...
    '["Exam-focused coverage for MTS, Postman & Mail Guard (MG)", "Coverage of relevant postal subjects, rules, and concepts", "Previous-year question papers included", "Concept-based notes, tables, and important rules", "Useful study material for revision and exam preparation"]', 
...
INSERT INTO products (
    ...
    '["PA / SA exam-focused study material", "Coverage of relevant postal subjects, manuals, and concepts", "Previous-year solved questions/papers", "Topic-wise practice questions and MCQs", "Concept-based explanations for easier preparation", "Useful revision material for exam preparation"]', 
    'Tenali Exams Publishers', 
    NULL, 
    100,
    '[{"code": "en", "name": "English"}, {"code": "te", "name": "Telugu"}, {"code": "hi", "name": "Hindi"}]'
