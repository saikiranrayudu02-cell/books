    ...
    <div style={{ paddingBottom: '80px' }}>
      <div className="page-header">
        ...
        <p className="page-subtitle">
          Enter your order details to check the delivery status
        </p>
      </div>
      ...
      <div className="container-narrow" style={{ maxWidth: '600px' }}>
        ...
        <div className="card p-6 md:p-8">
          <form onSubmit={handleTrack}>
            ...
            <div className="form-group" style={{ marginBottom: '24px' }}>
              <label className="form-label" htmlFor="contact">Email Address or Mobile Number</label>
              <input
                id="contact"
                type="text"
                className="form-input"
        ...
        {!isAuthenticated && (
          <div style={{
            ...
            <Link href="/login" style={{ color: 'var(--color-pastel-blue-deeper)', fontWeight: 600 }}>Log in</Link>
